...
const pastelColors = ['#FFB3BA', '#FFDFBA', '#FFFFBA', '#BAFFC9', '#BAE1FF', '#D9BAFF', '#FFBAF0', '#FFC3A0'];
...
const CustomizedContent = ({ depth, x, y, width, height, index, colors, name }) => {
  ...
  return (
    <g>
      <rect x={x} y={y} width={width} height={height} fill={fillColor} stroke="#fff" strokeWidth={2} />
      {width > 40 && height > 20 && (
        <text
          x={x + width / 2}
          y={y + height / 2}
