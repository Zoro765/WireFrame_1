        ...
        <div className="overflow-x-auto overflow-y-auto max-h-[500px]">
          <table className="min-w-full border-collapse border border-gray-300 rounded-lg">
            <thead className="bg-white">
              <tr className="sticky top-0 z-[0] bg-gradient-to-r from-white to-indigo-50">
                {[
                  "channel",
                  "type",
                  "brand",
                  ...
                  <th
                    ...
                    className="px-4 py-2 cursor-pointer border border-gray-300 text-left bg-white"
                    onClick={() => handleSort(typeof column === 'string' ? column : column.name as keyof DataRow)}
                  >
