...
export const SimulationOptimization: React.FC = () => {
  ...
  const [isScenarioLoaded, setIsScenarioLoaded] = useState(false); // State for scenario loading
  const [isOptimizeButtonVisible, setIsOptimizeButtonVisible] = useState(false); // State for Optimize button visibility
  ...
  const handleResetScope = () => {
    ...
    setIsScenarioLoaded(false); // Reset scenario loaded state
    setIsOptimizeButtonVisible(false); // Reset Optimize button visibility
  };
  ...
  const handleLoadScenario = () => {
    setIsScenarioLoaded(true); // Set scenario loaded state to true
    setIsOptimizeButtonVisible(true); // Make the Optimize button visible
    setIsScopeCollapsed(true); // Trigger the "Collapse" button effect
  };
  ...
  return (
    <div className="flex flex-col p-2 gap-4">
      ...
      {/* KPI Cards - Show only when scope is collapsed and scenario is loaded */}
      {isScopeCollapsed && isScenarioLoaded && (
      ...
      <div className="flex justify-between mt-4 mb-4">
        ...
        <div className="space-x-2">
          {/* Show Optimize button only when isOptimizeButtonVisible is true */}
          {isOptimizeButtonVisible && (
            <button
