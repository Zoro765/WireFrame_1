    ...
    <div className="space-y-6">
      ...
      {/* <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded shadow-sm p-4">
          <h2 className="text-lg font-semibold mb-4">Value Sales Performance by Region</h2>
          <ValueSalesByRegion />
        </div>

        <div className="bg-white rounded shadow-sm p-4">
          <h2 className="text-lg font-semibold mb-4">Value Sales Performance by Channel</h2>
          <ValueSalesByChannel />
        </div>

        <div className="bg-white rounded shadow-sm p-4 lg:col-span-2">
          <h2 className="text-lg font-semibold mb-4">Value Sales by Region Across Time</h2>
          <ValueSalesOverTime />
        </div>
      </div> */}
    </div>
